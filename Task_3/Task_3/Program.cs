...
namespace Task_3
{
    class Converter
    {
        ...
        public Converter(double UA_US, double UA_EU, double US_EU, double US_UA, double EU_US, double EU_UA)
        {
            UAH_USD = UA_US;
            UAH_EUR = UA_EU;
            USD_EUR = US_EU;
    ...
    class Program
    {
        ...
        {
            Converter C = new Converter(26.32, 30.4, 0.87, 26.59, 1.15, 30.73);
            ...
            do
            {
                ...
                Console.WriteLine("To Dolar -> USD || To Euro -> EUR  || To Uah -> UAH|| Exit -> EXIT");
